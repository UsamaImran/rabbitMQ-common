...
The current documentation describes the **v6 API and behavior**. Earlier versions are preserved as historical documentation:

- [v1 documentation](./v1.md)
- [v2 documentation](./v2.md)
- [v3 documentation](./v3.md)
- [v4 documentation](./v4.md)
- [v6 reliability notes](../technical/v6-reliability.md)

These historical documents describe earlier APIs and behavior and should not be used as the reference for the current v6 API.
