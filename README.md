...
CI runs the build and test suite on pushes and pull requests targeting `main` using Node.js 20. fileciteturn17file0L2-L2

## Documentation

- [v1 historical documentation](./docs/v1.md)
- [v2 historical documentation](./docs/v2.md)
- [v3 historical documentation](./docs/v3.md)
- [v4 historical documentation](./docs/v4.md)
- [v6 reliability notes](./technical/v6-reliability.md)

The version-specific documents are historical; the README describes the current v6 API and behavior.
